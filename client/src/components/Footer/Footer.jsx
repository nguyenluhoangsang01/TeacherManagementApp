...
const Footer = () => {
  return (
    <footer className="bg-[#013668] text-white p-4 grid grid-cols-1 space-y-8 md:grid-cols-2 lg:grid-cols-3 md:space-x-4 md:space-y-4 lg:space-y-0 lg:space-x-8 pb-12">
